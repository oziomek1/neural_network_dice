...
W neuronie obliczana jest suma ważona wejść, która porównywana jest z wartością progową,
inaczej biasem \cite{needForBias}. Przekroczenie wartości progowej uaktywnia neuron,
