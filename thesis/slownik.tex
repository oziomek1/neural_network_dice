...
sieci neuronowych \textit{Sieć neuronowa} \cite{intuitiveExplanation, WIKIcnn}. Posiada możliwość uczenia się poprzez obliczenia i przetwarzanie sygnałów
...
warstwami \cite{CS231n, substBigConv}. Istnieje wiele rodzajów warstw, a sygnał który przechodzi przez całą
...
Funkcja ta jest praktycznie nie wykorzystywana w sieciach neuronowych \cite{activationFunctions}.
Połączenie wielu warstw których neurony posiadają liniową funkcję aktywacji można przedstawić
...
dzięki zastosowaniu niewielkiego gradientu w sytuacji
...
treningowych. Najczęsciej korzysta się z więcej niż jednego przykładu co zapewnia
lepszą stabilność oraz wykorzystuje zrównoleglanie obliczeń. SGD zapewnia większą rozbieżność
